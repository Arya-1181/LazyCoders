...
<body>
	<main>
					...
					<div class="col-lg-10 col-10 d-flex flex-wrap">
						<p class="d-flex me-4 mb-0">
							<i class="bi-person custom-icon me-2"></i> <strong
								class="text-dark">InterviewBit Solutions</strong>
						</p>
					</div>
		...
		<section class="hero-section" id="section_1">
			<div class="center">
				<ul>
					<li><a class="click-scroll" href="interview/first.jsp">First
							non-repeating char in a stream of Numbers</a></li>
					<li><a class="click-scroll" href="interview/link.jsp">Linked list</a></li>
					<li><a class="click-scroll" href="interview/rev.jsp">Reverse from
							m to n</a></li>
					<li><a class="click-scroll" href="interview/rot.jsp">Rotate a
							linked list</a></li>
					<li><a class="click-scroll" href="interview/sol.jsp">Sort a linked
							list</a></li>
					<li><a class="click-scroll" href="interview/sob.jsp">Sort a binary
							linked list</a></li>
					<li><a class="click-scroll" href="interview/sum.jsp">Sum of two
							Linked list</a></li>
					<li><a class="click-scroll" href="interview/pick.jsp">Picking Numbers</a></li>
					<li><a class="click-scroll" href="interview/pro.jsp">Probability of occurance</a></li>
					<li><a class="click-scroll" href="interview/queen.jsp">Queen Attack</a></li>
