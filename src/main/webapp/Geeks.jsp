...
<body>
	<main>
					...
					<div class="col-lg-10 col-10 d-flex flex-wrap">
						<p class="d-flex me-4 mb-0">
							<i class="bi-person custom-icon me-2"></i> <strong
								class="text-dark">GeeksForGeeks Solutions</strong>
						</p>
					</div>
		...
		<section class="hero-section" id="section_1">
			<div class="center">
				<ul>
					<li><a class="click-scroll" href="gfg/first.jsp">Build a BST</a></li>
					<li><a class="click-scroll" href="gfg/cbs.jsp">Check for BST</a></li>
					<li><a class="click-scroll" href="gfg/crea.jsp">Creating a BST</a></li>
					<li><a class="click-scroll" href="gfg/find.jsp">Find minimum value in BST</a></li>
					<li><a class="click-scroll" href="gfg/ins.jsp">Insertion and deletion</a></li>
					<li><a class="click-scroll" href="gfg/int.jsp">Introduction and Search</a></li>
					<li><a class="click-scroll" href="gfg/lca.jsp">LCA in BST</a></li>
					<li><a class="click-scroll" href="gfg/add.jsp">Adding elements in Linked List</a></li>
					<li><a class="click-scroll" href="gfg/circ.jsp">Circular Linked List</a></li>
					<li><a class="click-scroll" href="gfg/del.jsp">Deleting Head</a></li>
