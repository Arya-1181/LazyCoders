...
<body>
	<main>
					...
					<div class="col-lg-10 col-10 d-flex flex-wrap">
						<p class="d-flex me-4 mb-0">
							<i class="bi-person custom-icon me-2"></i> <strong
								class="text-dark">Leetcode Solutions</strong>
						</p>
					</div>
		...
		<section class="hero-section" id="section_1">
			<div class="center">
				<ul>
					<li><a class="click-scroll" href="leetcode/add.jsp">Adding
							two Numbers</a></li>
					<li><a class="click-scroll" href="leetcode/rem.jsp">Removing
							duplicates</a></li>
					<li><a class="click-scroll" href="leetcode/ins.jsp">Insertion
							Sort</a></li>
					<li><a class="click-scroll" href="leetcode/Kan.jsp">Kangaroo</a></li>
					<li><a class="click-scroll" href="leetcode/kan+.jsp">Kangaroo++</a></li>
					<li><a class="click-scroll" href="leetcode/luck.jsp">Lucky
							Dates</a></li>
					<li><a class="click-scroll" href="leetcode/map.jsp">Maps</a></li>
					<li><a class="click-scroll" href="leetcode/max.jsp">Max
							and Min in a marix</a></li>
					<li><a class="click-scroll" href="leetcode/nyc.jsp">New
							year chaos</a></li>
					<li><a class="click-scroll" href="leetcode/oew.jsp">odd
							even weird</a></li>
