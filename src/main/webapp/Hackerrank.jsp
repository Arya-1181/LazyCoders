...
<body>
	<main>
		<header class="site-header">
			<div class="container">
				<div class="row">
					<div class="col-lg-10 col-10 d-flex flex-wrap">
						<p class="d-flex me-4 mb-0">
							<i class="bi-person custom-icon me-2"></i> <strong
								class="text-dark">HackerRank Solutions</strong>
						</p>
					</div>
		...
		<section class="hero-section" id="section_1">
			<div class="center">
				<ul>
					<li><a class="click-scroll" href="hackerrank/3d_surface.jsp">3d surface</a></li>
					<li><a class="click-scroll" href="hackerrank/AbsoluteDif.jsp">Absolute
							difference</a></li>
					<li><a class="click-scroll" href="hackerrank/AbsolutePer.jsp">Absolute
							Permutation</a></li>
					<li><a class="click-scroll" href="hackerrank/algo.jsp">algorithms</a></li>
					<li><a class="click-scroll" href="hackerrank/almostsorted.jsp">Almost_Sorted</a></li>
					<li><a class="click-scroll" href="hackerrank/array.jsp">Array_n</a></li>
					<li><a class="click-scroll" href="hackerrank/arrayn.jsp">Array
							manipulation</a></li>
					<li><a class="click-scroll" href="hackerrank/bal.jsp">Balanced
							Brackets</a></li>
					<li><a class="click-scroll" href="hackerrank/beauty.jsp">Beautiful Day
							at the movies</a></li>
					<li><a class="click-scroll" href="hackerrank/beautys.jsp">Beautiful
							string</a></li>
					<li><a class="click-scroll" href="hackerrank/binary.jsp">BinaryCount</a></li>
					<li><a class="click-scroll" href="hackerrank/bomb.jsp">Bomber man</a></li>
					<li><a class="click-scroll" href="hackerrank/cavity.jsp">Cavity map</a></li>
					<li><a class="click-scroll" href="hackerrank/dna.jsp">DNA health</a></li>
					<li><a class="click-scroll" href="hackerrank/dou.jsp">Double
							Sorting</a></li>
				</ul>
			</div>
		</section>
				...
				<div class="row">
					...
					<div
						...
						<ul class="social-icon d-flex justify-content-lg-end">
							...
							<li class="social-icon-item"><a href="#"
								class="social-icon-link"> <span class="bi-apple"></span>
							</a></li>
